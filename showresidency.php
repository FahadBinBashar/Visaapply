...
$sql = "SELECT resid, choice, start, expiry, filename, status FROM residency where cid='".$_SESSION['loginuser']."' AND resid = '".$_GET['id']."'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> New Residency Card (TIE/NIE) Applications - <span style="color:#F44336;"><?php echo $row1['status']; ?></span></b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="header-section">
      ...
      <p class="lead"><b>European Passport?</b> <?php echo $row1['choice']; ?></p>
       ...
       <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            foreach ($fileData as $index => $file) {
                ...
                if (!empty($file['filename'])) {
                    echo '<a href="downloadres.php?id=' . $file['resid'] . '" class="btn btn-light btn-sm" target="_blank">Download All</a>';
                } else {
                    echo 'No file uploaded';
                }
