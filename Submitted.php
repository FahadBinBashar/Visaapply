...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> Submitted Applications</b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
   <div class="card-container">
        <div class="card">
            ...
            <p>Total: <b><?php echo $_SESSION['atotal']; ?></b></p>
            <div class="btn">
                <a href="edsubmitted.php">View Submissions</a>
            </div>
        </div>
  <div class="card">
            <h3>Legal Submissions</h3>
            <p>Total: <b><?php echo $_SESSION['ltotal']; ?></b></p>
            <div class="btn">
                <a href="legsubmitted.php">View Submissions</a>
            </div>
        </div>
        </div>
    </div> 
