...
?>
<html>
<title>Dashboard | Legal Forms</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-legal"></i> Legal Forms</b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
   <div class="card-container">
        <div class="card">
            ...
            <div class="btn">
                <a href="visa.php">Submit Application</a>
            </div>
        </div>
  <div class="card">
            <h3>Request new residency card (TIE/NIE)</h3>
            <div class="btn">
                <a href="residency.php">Submit Application</a>
            </div>
        </div>
    </div> 
 <div class="card-container">
        <div class="card">
            <h3>Renewal new residency card (TIE/NIE)</h3>
            <div class="btn">
                <a href="renewal.php">Submit Application</a>
            </div>
        </div>
  <div class="card">
            <h3>Empadronamiento/domiciliation</h3>
            <div class="btn">
                <a href="domiciliation.php">Submit Application</a>
            </div>
        </div>
    </div> 
 <div class="card-container">
        <div class="card">
            <h3>Other legal issue</h3>
            <div class="btn">
                <a href="otherlegal.php">Submit Application</a>
            </div>
        </div>
</div>
