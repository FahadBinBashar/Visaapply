...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-row-padding w3-margin-bottom">
   <div class="card-container">
        <div class="card">
            <h3>Research Educational Journey</h3>
            <div class="btn">
                <a href="Research.php">Submit Application</a>
            </div>
        </div>
  <div class="card">
            <h3>Application to Academic Institution of Choice</h3>
            <div class="btn">
                <a href="institution.php">Submit Application</a>
            </div>
        </div>
    </div> 
 <div class="card-container">
        <div class="card">
            <h3>Recognition/Homologation of Your Degree</h3>
            <div class="btn">
                <a href="recognition.php">Submit Application</a>
            </div>
        </div>
  <div class="card">
            <h3>Support during your Education</h3>
            <div class="btn">
                <a href="Support.php">Submit Application</a>
            </div>
        </div>
    </div> 
</div>
