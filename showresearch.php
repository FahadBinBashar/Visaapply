...
$sql=("SELECT * from research where cid='".$_SESSION['loginuser']."' AND rid = '".$_GET['id']."'");
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> Research Educational Journey Submissions - <span style="color:#F44336;"><?php echo $row['status']; ?></span></b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="header-section">
      <h2 class="display-4 mb-4"><?php echo $_SESSION['uname']; ?></h2>
      <p class="lead"><b>Email:</b> <?php echo $_SESSION['email']; ?> | <b>Phone:</b> <?php echo $_SESSION['phone']; ?></p>
      <p class="lead"><b>Birthdate:</b> <?php echo $_SESSION['dob']; ?> | <?php echo $_SESSION['city'];?>, <?php echo $_SESSION['country']; ?></p>
      <p class="lead"><b>Study Status:</b> <?php echo $_SESSION['status']; ?></p>
      <p class="lead"><b>Date of Registration:</b> <?php echo $_SESSION['dor']; ?></p>
      <p class="lead"><b>Degree you are looking for:</b> <?php echo $row['degree']; ?></p>
      <p class="lead"><b>Field of studies are you interested in:</b> <?php echo $row['field']; ?></p>
      <p class="lead"><b>Institution Choice:</b> <?php echo $row['choice']; ?></p>
      <p class="lead"><b>City of Choice:</b> <?php echo $row['dcity']; ?></p>
    </div>
