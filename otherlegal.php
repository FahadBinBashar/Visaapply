...
?>
<html>
<title>Dashboard | Other Legal Issues</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-legal"></i> Other Legal Issues</b></h5>
  </header>


 <div class="w3-row-padding w3-margin-bottom">
    <div class="form-container">
        <form action="Actions/otherlegalform.php" method="post" enctype="multipart/form-data">
            <div class="form-grid">
