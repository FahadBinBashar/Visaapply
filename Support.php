...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-book"></i> Support during your Education</b></h5>
  </header>


 <div class="w3-row-padding w3-margin-bottom">
    <div class="form-container">
        <form action="Actions/supportform.php" method="post">
            <div class="form-grid">
                <div class="form-group">
                    <label for="subject" class="form-label">What is the subject you want to talk about?</label><br>
                    <textarea type="textarea" id="subject" rows="4" cols="100" class="form-input" name="subject" required></textarea>
                </div>
            </div>
            <br>
