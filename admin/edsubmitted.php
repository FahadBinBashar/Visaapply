...
// Institution
$sqlins = "SELECT institution.iid, institution.rdate, institution.status, users.name
FROM institution
INNER JOIN users ON institution.cid = users.id";
$resultins = $conn->query($sqlins);

// Recognition
$sqlrec = "SELECT recognition.rid, recognition.rdate, recognition.status, users.name
FROM recognition
INNER JOIN users ON recognition.cid = users.id";
$resultrec = $conn->query($sqlrec);

// Support
$sqlsup = "SELECT support.sid, support.subject, support.rdate, support.status, users.name
FROM support
INNER JOIN users ON support.cid = users.id";
  ...
  <div class="tab-content">
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['rid']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeresModal data-whatever='".$row['rid']."' data-name='".$row['name']."'  width=30 height=30></center></td>";
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="actions/delres.php" method="POST">
...
<div class="modal fade" id="approveProductModal" role="dialog">
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['iid']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeinsModal data-whatever='".$row['iid']."' data-name='".$row['name']."'  width=30 height=30></center></td>";
   ...
   <div class="modal fade" id="removeinsModal" role="dialog">
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="actions/delins.php" method="POST">
...
<div class="modal fade" id="approveProductModal" role="dialog">
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['rid']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removerecModal data-whatever='".$row['rid']."' data-name='".$row['name']."'  width=30 height=30></center></td>";
   ...
   <div class="modal fade" id="removerecModal" role="dialog">
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="actions/delrec.php" method="POST">
...
<div class="modal fade" id="approveProductModal" role="dialog">
   ...
   <div class="modal fade" id="removesupModal" role="dialog">
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="actions/delsup.php" method="POST">
...
$('#removeresModal').on('show.bs.modal', function (event) {
 ...
 // Extract info from data-* attributes
  ...
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Deleting Research Application for ' + name)
  modal.find('.modal-body #recipient-id').val(recipient)
})
$('#removeinsModal').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the modal
  var recipient = button.data('whatever')
  var name = button.data('name')
 ...
 // Extract info from data-* attributes
  ...
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Deleting Institution Application for ' + name)
  modal.find('.modal-body #recipient-id').val(recipient)
})
$('#removerecModal').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the modal
  var recipient = button.data('whatever')
  var name = button.data('name')
 ...
 // Extract info from data-* attributes
  ...
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Deleting Recognition Application for ' + name)
  modal.find('.modal-body #recipient-id').val(recipient)
})
$('#removesupModal').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the modal
  var recipient = button.data('whatever')
  var name = button.data('name')
 ...
 // Extract info from data-* attributes
  ...
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Deleting Support Application for ' + name)
  modal.find('.modal-body #recipient-id').val(recipient)
})
