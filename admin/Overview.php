...
$query = "
    ...
    FROM (
        SELECT cid FROM research
        UNION ALL
        SELECT cid FROM support
        UNION ALL
        SELECT cid FROM institution
        UNION ALL
        SELECT cid FROM recognition
    ) AS combined_table;
";
...
$query = "
     SELECT COUNT(*) AS total_cid_count
    FROM (
        SELECT cid FROM visa
        UNION ALL
        SELECT cid FROM residency
        UNION ALL
        SELECT cid FROM renewal
        UNION ALL
        SELECT cid FROM domiciliation
        UNION ALL
        SELECT cid FROM otherlegal
    ) AS combined_table;
";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-row-padding w3-margin-bottom">
      ...
      <div class="w3-container w3-purple w3-padding-16">
        ...
        <div class="w3-right">
          <h3><?php echo $_SESSION['loginadmin']; ?></h3>
        </div>
