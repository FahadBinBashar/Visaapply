...
$sql=("SELECT research.*, users.*
FROM research
INNER JOIN users ON research.cid = users.id
WHERE research.rid = '".$_GET['id']."'");
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> Research Educational Journey Submissions</b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="header-section">
      <h2 class="display-4 mb-4"><?php echo $row['name']; ?></h2>
      <p class="lead"><b>Email:</b> <?php echo $row['email']; ?> | <b>Phone:</b> <?php echo $row['phone']; ?></p>
      <p class="lead"><b>Birthdate:</b> <?php echo $row['birthdate']; ?> | <?php echo $row['city'];?>, <?php echo $row['country']; ?></p>
      <p class="lead"><b>Study Status:</b> <?php echo $row['status']; ?></p>
      <p class="lead"><b>Date of Registration:</b> <?php echo $row['regdate']; ?></p>
