...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-book"></i> Recognition/homologation of Your Degree</b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
    <div class="form-container">
      ...
      unset($_SESSION['upload_success']);
        ...
        <form action="Actions/recognitionform.php" method="post" enctype="multipart/form-data">
            <div class="form-grid">
                <div class="form-group">
                    <label for="choice" class="form-label">What kind of diploma do you need to homologate?  </label>
                    <select id="choice" class="form-select" name="choice" required>
                        <option value="" disabled selected>Select Diploma</option>
                        <option value="High School">High School Diploma</option>
                        <option value="Bachelors">Bachelor's Diploma</option>
                        <option value="Masters">Master's Diploma</option>
                    </select>
                </div>
                <div class="form-group">
