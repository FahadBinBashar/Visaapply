...
// Visa
$sqlv = "SELECT vid, rdate, status FROM visa WHERE cid = '$loginuser'";
$resultv = $conn->query($sqlv);

// Residency
$sqlres = "SELECT resid, rdate, status FROM residency WHERE cid = '$loginuser'";
$resultres = $conn->query($sqlres);

// Renewal
$sqlren = "SELECT renid, rdate, status FROM renewal WHERE cid = '$loginuser'";
$resultren = $conn->query($sqlren);

// Support
$sqld = "SELECT did, rdate, status FROM domiciliation WHERE cid = '$loginuser'";
$resultd = $conn->query($sqld);

// Other
$sqlo = "SELECT lid, subject, rdate, status FROM otherlegal WHERE cid = '$loginuser'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-row-padding w3-margin-bottom">
    ...
    <li class="active"><a data-toggle="tab" href="#visa">Visa Appointment</a></li>
  ...
  <div class="tab-content">
    <div id="visa" class="tab-pane fade in active">
        <br>
      <table id="visa1" class="display nowrap" style="width:100%;">
        <thead>
            <tr>
                <th>ID</th>
                <th>Type</th>
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['vid']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeProductModal data-whatever='".$row['vid']."' data-name='".$row['rdate']."'  width=30 height=30></center></td>";
...
<div class="modal fade" id="approveProductModal" role="dialog">
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['resid']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeProductModal data-whatever='".$row['resid']."' data-name='".$row['rdate']."'  width=30 height=30></center></td>";
...
<div class="modal fade" id="approveProductModal" role="dialog">
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['renid']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeProductModal data-whatever='".$row['renid']."' data-name='".$row['rdate']."'  width=30 height=30></center></td>";
...
<div class="modal fade" id="approveProductModal" role="dialog">
    ...
    // output data of each row
      ...
      <input name=id type=hidden value='".$row['did']."'> <center><input type=image src=img/views.png alt=Submit width=25 height=13 style = margin-top:15px;></form></center></td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeProductModal data-whatever='".$row['did']."' data-name='".$row['rdate']."'  width=30 height=30></center></td>";
...
<div class="modal fade" id="approveProductModal" role="dialog">
    ...
    // output data of each row
      ...
      echo "<td>".$row['status']."</td>";
        ...
        echo "<td><center>
        <input type=image src=img/deletes.png data-toggle=modal data-target=#removeProductModal data-whatever='".$row['lid']."' data-name='".$row['rdate']."'  width=30 height=30></center></td>";
