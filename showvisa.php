...
$sql = "SELECT vid, filename, status FROM visa where cid='".$_SESSION['loginuser']."' AND vid = '".$_GET['id']."'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> Visa Appointment Applications - <span style="color:#F44336;"><?php echo $row1['status']; ?></span></b></h5>
  </header>
       ...
       <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            foreach ($fileData as $index => $file) {
                ...
                if (!empty($file['filename'])) {
                    echo '<a href="downloadvis.php?id=' . $file['vid'] . '" class="btn btn-light btn-sm" target="_blank">Download All</a>';
                } else {
                    echo 'No file uploaded';
                }
