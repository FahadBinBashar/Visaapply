...
if ($_SESSION['loginuser'] == true) {
    ...
    foreach ($_FILES as $file) {
        ...
        // File upload path
        $targetDir = "../domiciliationuploads/";
    ...
    $sql = "INSERT INTO domiciliation (cid, filename, status, rdate) VALUES ('$did','$insertValuesSQL','$status','$rdate')";
...
header("Location: ../domiciliation.php");
?>
