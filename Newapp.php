...
$userInfoQuery = "SELECT phone, birthdate, country, city, status FROM users WHERE id = $userId";
    $stmt = $conn->prepare($userInfoQuery);
    //$stmt->bind_param("i", $userId);
    $stmt->execute();
    $stmt->bind_result($phone, $birthdate, $country, $city, $status);
    $stmt->fetch();
    $stmt->close();
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="Newapp.php" class="w3-bar-item w3-button w3-padding w3-red"><i class="fa fa-clipboard"></i> General Information</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-clipboard"></i> General Information</b></h5>
  </header>


 <div class="w3-row-padding w3-margin-bottom">
    <div class="form-container">
        <form action="Actions/updateinfo.php" method="post">
            <div class="form-grid">

                <div class="form-group">
                    <label for="phone" class="form-label">Phone number</label>
                    <input type="tel" id="phone" class="form-input" name="phone" value="<?php echo $phone; ?>" required>
                </div>

                <div class="form-group">
                    <label for="birthdate" class="form-label">Birth date</label>
                    <input type="date" id="birthdate" class="form-input" name="birthdate" value="<?php echo $birthdate; ?>" required>
                </div>

                <div class="form-group">
                    <label for="country" class="form-label">Country</label>
                    <input type="text" id="country" class="form-input" name="country" value="<?php echo $country; ?>" required>
                </div>

                <div class="form-group">
                    <label for="city" class="form-label">City/Town</label>
                    <input type="text" id="city" class="form-input" name="city" value="<?php echo $city; ?>" required>
                </div>
        ...
        $statusOptions = array("high school student", "graduated student", "professional education student", "bachelor student", "master student", "PhD student", "working professional");

        // Iterate through the options and generate the HTML
        foreach ($statusOptions as $option) {
            // Check if the option matches the user's stored status
