...
$sql = "SELECT did, filename, status FROM domiciliation where cid='".$_SESSION['loginuser']."' AND did = '".$_GET['id']."'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> Domiciliation Applications - <span style="color:#F44336;"><?php echo $row1['status']; ?></span></b></h5>
  </header>
       ...
       <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            foreach ($fileData as $index => $file) {
                ...
                if (!empty($file['filename'])) {
                    echo '<a href="downloaddom.php?id=' . $file['did'] . '" class="btn btn-light btn-sm" target="_blank">Download All</a>';
                } else {
                    echo 'No file uploaded';
                }
