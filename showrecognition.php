...
$sql = "SELECT rid, choice, filename, status FROM recognition where cid='".$_SESSION['loginuser']."' AND rid = '".$_GET['id']."'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i>Recognition/Homologation of Degree Applications- <span style="color:#F44336;"><?php echo $row1['status']; ?></span></b></h5>
  </header>
 ...
 <div class="w3-row-padding w3-margin-bottom">
    ...
    <div class="header-section">
      ...
      <p class="lead"><b>Diploma needed to Homologate:</b> <?php echo $row1['choice']; ?></p>
       ...
       <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            foreach ($fileData as $index => $file) {
                ...
                if (!empty($file['filename'])) {
                    echo '<a href="downloadrec.php?id=' . $file['rid'] . '" class="btn btn-light btn-sm" target="_blank">Download All</a>';
                } else {
                    echo 'No file uploaded';
                }
