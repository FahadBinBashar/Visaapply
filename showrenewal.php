...
$sql = "SELECT renid, start, expiry, filename, status FROM renewal where cid='".$_SESSION['loginuser']."' AND renid = '".$_GET['id']."'";
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-circle"></i> Residency Card (TIE/NIE) Renewal Applications  - <span style="color:#F44336;"><?php echo $row1['status']; ?></span></b></h5>
  </header>
